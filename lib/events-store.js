...
// A connected store on Vercel exposes BLOB_STORE_ID; the SDK obtains the OIDC
// token itself, so VERCEL_OIDC_TOKEN is not reliably readable from process.env.
// BLOB_READ_WRITE_TOKEN covers code running outside Vercel.
