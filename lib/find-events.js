  ...
  const data = await callClaude(
    {
      ...
      max_tokens: 8000,
      // "medium" trades a little thoroughness for meaningfully fewer thinking
      // tokens and fewer, more consolidated searches. Default is "high".
      output_config: { effort: "medium" },
      // Drops earlier search results out of context as the run proceeds, so
      // later searches aren't re-reading everything the earlier ones returned.
